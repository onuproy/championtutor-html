! function ($) {
    ...
    Multiselect.prototype = {
        defaults: {
            ...
            templates: {
                button: '<button type="button" class="multiselect dropdown-toggle" data-toggle="dropdown">Choose Subject</button>',
                ul: ' <ul class="multiselect-container dropdown-menu"></ul>',
                filter: '<li class="multiselect-item filter"><div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-search"></i></span><input class="form-control multiselect-search" type="text"></div></li>',
                filterClearBtn: '<span class="input-group-btn"><button class="btn btn-default multiselect-clear-filter" type="button"><i class="glyphicon glyphicon-remove-circle"></i></button></span>',
                li: '<li><img class="uncheck_img" src="http://chhatri.in/revamp-html/assets/images/icon/input-uncheck.png" alt="Icon"><img class="check_image" src="http://chhatri.in/revamp-html/assets/images/icon/input-chck.png" alt="Icon"><a href="javascript:void(0);"><label></label></a></li>',
    ...
    // jQuery('.multiselect-container').click(function () {
    //     jQuery('.multiselect').addClass('multiselect-active-color');
    //     return false;
    // });
